    ...
    <div className="w-[380px] bg-gradient-to-br from-[#008080] to-[#006666] p-8 flex flex-col items-center shadow-2xl">
      ...
      <main className="w-full flex flex-col gap-3">
        <button className="group w-full bg-gradient-to-r from-[#1a1a1a] to-[#121212] hover:from-[#252525] hover:to-[#1a1a1a] text-white py-4 px-6 rounded-2xl font-semibold text-base transition-all! duration-300! border-none shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] flex items-center justify-between">
          ...
          <FileText className="w-5 h-5 opacity-70 group-hover:opacity-100 group-hover:translate-x-1 transition-al!" />
        </button>
        ...
        <div className="mt-3 relative">
          ...
          <button className="group relative w-full bg-white hover:bg-gray-50 text-[#05cbcb] py-4 px-6 rounded-2xl font-bold text-base transition-all! duration-300! shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2 uppercase tracking-wide">
