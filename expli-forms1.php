...
class Expli_Forms_Plugin {
    ...
    public function enqueue_assets() {
        ...
        // Register handles
        wp_register_script( $handle, plugins_url( '/assets/expli-forms.js', __FILE__ ), [ 'jquery' ], '1.3', true );
        wp_register_style( 'expli-forms-style', plugins_url( '/assets/expli-forms.css', __FILE__ ), [], '1.3' );
        ...
        $templates = [
            ...
            [
                ...
                'fields' => [
                    ...
                    // "Can you make it?" - Using Select as a Radio replacement
                    ...
                    // "Bringing anything else?" - Separate checkboxes
            ...
            // 2. Terms of Service Contact Form
            [
                'id' => 'tpl_tos',
            ...
            [
                ...
                'fields' => [
                    ...
                    // Simplified Time block to Select to avoid 10 separate checkbox fields
